...
/**
 * The hardware-back contract with the page (packages/web/src/lib/shell.ts):
 * the activity evaluates {@link #PROBE_JS} in the WebView and reads the
 * answer. Pure so it is unit-testable off-device; the WebView call itself is
 * three lines in MainActivity.
 */
